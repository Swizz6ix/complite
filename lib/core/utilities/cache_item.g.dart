...
extension CacheItemQueryFilter
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonEqualTo(
    String value, {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'json',
        value: '',
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> jsonIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'json',
        value: '',
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> timestampEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> timestampLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterFilterCondition> timestampBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CacheItemQuerySortBy on QueryBuilder<CacheItem, CacheItem, QSortBy> {
  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> sortByJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'json', Sort.asc);
    });
  }

  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> sortByJsonDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> sortByTimestamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timestamp', Sort.asc);
    });
  }

  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> sortByTimestampDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CacheItemQuerySortThenBy
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> thenByJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'json', Sort.asc);
    });
  }

  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> thenByJsonDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'json', Sort.desc);
    });
  }
  ...
  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> thenByTimestamp() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timestamp', Sort.asc);
    });
  }

  QueryBuilder<CacheItem, CacheItem, QAfterSortBy> thenByTimestampDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'timestamp', Sort.desc);
    });
  }
...
extension CacheItemQueryWhereDistinct
  ...
  QueryBuilder<CacheItem, CacheItem, QDistinct> distinctByJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, CacheItem, QDistinct> distinctByTimestamp() {
    return QueryBuilder.apply(this, (query) {
...
extension CacheItemQueryProperty
  ...
  QueryBuilder<CacheItem, String, QQueryOperations> jsonProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CacheItem, DateTime, QQueryOperations> timestampProperty() {
    return QueryBuilder.apply(this, (query) {
